...
if(isset($_GET['del'])=='data'){
    $delqry = mysqli_query($con,"delete from user where id = '".$_GET['id']."'");
                                                        ...
                                                        <td><?php echo $row['email'];?></td>
                                                         <td><?php echo $row['mobile'];?></td>
                                                          ...
                                                          <form name="abc" action="" method="post">
                                                           ...
                                                           <a href="manage-users.php?id=<?php echo $row['id'];?>&del=data" class="btn btn-danger btn-xs btn-mini">Delete</a> 
